...
import "./Question.css";
import somuImage from "./Somu.jpg"; // Import the image from the components folder

const Question = () => {
  const messages = [
    "Aww, that's so sweet! I love you too! ❤️",
    ...
    "Well, you’re officially my favorite person now! 😄❤️",
    "Did I just win the jackpot? Yes, yes, yes! You’re the one! 💖🎉",
    "I didn’t know my heart could be this full... Yes, I love you! 💕",
    "Of course, I do! You’re the best thing that’s ever happened to me. ❤️👑",
  ...
  const moveNoButton = (e) => {
    ...
    const randomY = Math.floor(Math.random() * window.innerHeight - 25);
  ...
  return (
    <div className="question-container">
      ...
      <div className="buttons">
        <button id="yes" onClick={handleClickYes}>Yes</button>
